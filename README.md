...
-│ │ ├── auth.go # Авторизация
-│ │ ├── chats.go # Чаты
-│ │ ├── chats_create.go # Создание чатов
-│ │ ├── chat_members.go # Участники чатов
-│ │ ├── chat_pin.go # Закрепление сообщений
-│ │ ├── chat_rename.go # Переименование чатов
-│ │ ├── chat_search.go # Поиск по сообщениям
-│ │ ├── chat_settings.go # Мьют, передача прав
-│ │ ├── chat_sync.go # Синхронизация
-│ │ ├── messages.go # Сообщения
-│ │ ├── message_actions.go # Пересылка
-│ │ ├── user_blocks.go # Блокировки
-│ │ ├── user_status.go # Статусы онлайн
...
-├── test_api.html # HTML клиент для тестов
