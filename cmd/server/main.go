...
func main() {
	...
	api.Use(middleware.AuthMiddleware())
	{
		...
		api.POST("/messages/:message_id/reactions", handlers.AddReaction)
		api.DELETE("/messages/:message_id/reactions/:emoji", handlers.RemoveReaction)
		api.GET("/messages/:message_id/reactions", handlers.GetReactions)
