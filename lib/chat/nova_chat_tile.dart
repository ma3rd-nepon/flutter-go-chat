                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: unreadActive ? NovaTheme.flame : NovaTheme.ink,
                            width: 2,
                          ),
                        ),
                        child: Center(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          height: 12,
                          decoration: BoxDecoration(
                            color: widget.online ? NovaTheme.flame : NovaTheme.muted,
                            shape: BoxShape.circle,
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                fontSize: 11,
                                color: unreadActive ? NovaTheme.flame : NovaTheme.muted,
                              ),
                            ),
                          ],
                        ),
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  fontSize: 13,
                                  color: unreadActive
                                      ? NovaTheme.paper.withValues(alpha: 0.8)
                                      : NovaTheme.muted,
                                ),
                              ),
                            ),
