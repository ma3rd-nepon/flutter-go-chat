          ...
          children: [
                  ...
                  MouseRegion(
                    ...
                    child: GestureDetector(
                      ...
                      child: const Padding(
                        ...
                        child: NovaIconBack(color: NovaTheme.paper),
                      ),
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          height: 11,
                          decoration: BoxDecoration(
                            color: widget.chat.online ? NovaTheme.flame : NovaTheme.muted,
                            shape: BoxShape.circle,
                            border: Border.all(color: NovaTheme.ink, width: 2),
                          ),
                        ),
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                color: NovaTheme.surface,
                border: Border(
                  top: BorderSide(color: NovaTheme.ink, width: 2),
                ),
              ),
              child: Row(
                children: [
                  ...
                  NovaFloatingActionButton(
                    onPressed: _send,
                    child: const NovaIconSend(color: NovaTheme.ink),
                  ),
                ],
              ),
            ),
