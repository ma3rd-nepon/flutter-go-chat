    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _focused ? NovaTheme.flame : NovaTheme.ink,
            width: NovaTheme.borderWidth,
          ),
          boxShadow: [
            BoxShadow(
        ...
        child: Column(
          ...
          children: [
            ...
            EditableText(
              ...
              cursorColor: NovaTheme.flame,
              backgroundCursorColor: NovaTheme.muted,
              selectionColor: NovaTheme.flame.withValues(alpha: 0.35),
              style: TextStyle(
