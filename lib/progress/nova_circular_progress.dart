...
class _RingPainter extends CustomPainter {
  _RingPainter({required this.value, required this.t, required this.strokeWidth});
    ...
    canvas.drawArc(
      ...
      Paint()
        ...
        ..shader = SweepGradient(
          colors: [NovaTheme.flame, NovaTheme.gold, NovaTheme.flame],
        ).createShader(rect),
    );
