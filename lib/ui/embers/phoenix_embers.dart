  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: _EmbersPainter(_embers, _controller.value, colors),
        );
      },
    );
  }
...
class _EmbersPainter extends CustomPainter {
  _EmbersPainter(this.embers, this.t, this.colors);
  ...
  void paint(Canvas canvas, Size size) {
    for (final ember in embers) {
      ...
      final color = Color.lerp(colors.primary, colors.primaryHover, ember.phase)!
