        ...
        children: [
                ...
                leading: MouseRegion(
                  ...
                  child: GestureDetector(
                    ...
                    child: const Padding(
                      ...
                      child: NovaIconMenu(color: colors.textPrimary),
                    ),
                  ),
                ),
          ...
          Positioned(
            ...
            child: NovaFloatingActionButton(
              ...
              child: const NovaIconChat(color: colors.border),
            ),
          ),
          NovaDrawer(
            open: _drawerOpen,
            ...
            child: Column(
              ...
              children: [
                ...
                const NovaDivider(),
                NovaListTile(
                  leading: const NovaIconUser(color: colors.primary),
                  title: const Text('Профиль'),
                  subtitle: const Text('эмир@supernova'),
                  onTap: () => setState(() => _drawerOpen = false),
                ),
                NovaListTile(
                  leading: const NovaIconFlame(color: colors.primaryHover),
                  title: const Text('Избранное'),
                  onTap: () => setState(() => _drawerOpen = false),
                ),
                NovaListTile(
                  leading: const NovaIconChat(color: colors.textDisabled),
...
class _StripesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var x = -size.height; x < size.width; x += 14) {
      ...
      canvas.drawPath(
        path,
        Paint()..color = i.isEven ? colors.primary : colors.primaryHover,
      );
      i++;
    }
  }
