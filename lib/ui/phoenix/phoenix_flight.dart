  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return CustomPaint(
          painter: _ScenePainter(t, _frames, frame, context.colors),
        );
      },
    );
  }
...
class _ScenePainter extends CustomPainter {
  _ScenePainter(this.t, this.frames, this.frame, this.colors);
  ...
  void _drawBackground(Canvas canvas, Size size) {
    final paint = Paint()
      ..shader = LinearGradient(
        ...
        colors: [colors.background, Color(0xFF2B0D04)],
  ...
  void _drawSun(Canvas canvas, Size size) {
    ...
    final halo = Paint()
      ...
      ..shader = RadialGradient(
        colors: [
          colors.primaryHover.withValues(alpha: 0.5),
    ...
    final rayPaint = Paint()
      ..blendMode = BlendMode.plus
      ..color = colors.primaryHover.withValues(alpha: 0.12);
    canvas.save();
    ...
    final disc = Paint()
      ..shader = RadialGradient(
        colors: [Color(0xFFFFF6D8), colors.primaryHover, colors.primary],
  ...
  void _drawTrail(Canvas canvas, Size size) {
    for (var i = 0; i < 28; i++) {
      ...
      final paint = Paint()
        ..blendMode = BlendMode.plus
        ..color = Color.lerp(colors.primaryHover, colors.error, i / 28)!
